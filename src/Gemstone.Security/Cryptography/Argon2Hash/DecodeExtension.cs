...
public static class DecodeExtension
{
    ...
    /// </para>
    /// </remarks>
    public static bool DecodeString(this Argon2Config config, string str, out ZeroedBuffer<byte>? hash)
    {
        if (config == null)
        ...
        ZeroedBuffer<byte> output = new(hashLength);
    ...
    private static uint Base64CharToByte(int c)
    {
        ...
        uint x = ((((((uint)c - 'A') >> 8) & 0xFF) ^ 0xFF) & (((('Z' - (uint)c) >> 8) & 0xFF) ^ 0xFF) & (uint)(c - 'A'))
            | ((((((uint)c - 'a') >> 8) & 0xFF) ^ 0xFF) & (((('z' - (uint)c) >> 8) & 0xFF) ^ 0xFF) & (uint)(c - ('a' - 26)))
            | ((((((uint)c - '0') >> 8) & 0xFF) ^ 0xFF) & (((('9' - (uint)c) >> 8) & 0xFF) ^ 0xFF) & (uint)(c - ('0' - 52)))
            | (((((0U - ((uint)c ^ '+')) >> 8) & 0xFF) ^ 0xFF) & 62U)
            | (((((0U - ((uint)c ^ '/')) >> 8) & 0xFF) ^ 0xFF) & 63U);
        
        return x | (((((0U - (x ^ 0)) >> 8) & 0xFF) ^ 0xFF) & ((((0U - ((uint)c ^ 'A')) >> 8) & 0xFF) ^ 0xFF ^ 0xFF));
    }
