...
public sealed partial class Argon2
{
    ...
    {
        // FUTURE: figure out and lift the code from Blake2BCore-FullyUnrolled.cs
        ulong[] buf = new ulong[QwordsInBlock * 2];
        BlockValues blockR = new(buf, 0);
        BlockValues blockTmp = new(buf, 1);
